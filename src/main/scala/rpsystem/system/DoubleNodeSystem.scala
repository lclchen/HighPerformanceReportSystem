...
class CommandMiddlewareOfDoubleNodeSystem {
  var actorSystemName:String = "DoubleNodeReportSystem_CommandMiddleware"
  val config: Config = ConfigFactory.load("./system/double_node.conf")
...
class DomainOfDoubleNodeSystem {
  var actorSystemName:String = "DoubleNodeReportSystem_Domain"
  val config: Config = ConfigFactory.load("./system/double_node.conf")
